...
\title{Overview on HRP UWB\\standard 802.15.4-2024}
...
if in use k=7 can be optionally employed over k=3. If k=7 is used, datarate is higher
compared to Reed-Solomon encoding at 249.6 MHz PRF, the latter is disabled on the PSDU, moreover the encoder
is run over the whole PHR (in halved datarate) and PSDU.\\

...
determining the position (0 or 1) and the second the phase (-1 or +1). In each symbol
...
so enables binary position modulation and $T_{dsym}=N_{c}T_{c}$.\\
...
$N_{burst}=T_{dsym}/T_{burst}$ is the number of brust durations in a symbol.
